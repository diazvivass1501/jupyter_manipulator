function []=tubo(K,alto,radio,color)
% Esta función se utiliza para dibujar un cilindro hueco con el eje de
% simetría en Z y partiendo del origen. Se requiere tener instalado el 
% toolbox freezeColors para exportar a objeto U3D
% 
% Ejemplo de uso: tubo(trans(1,1,1),0.8,0.5,'red')
%
% Parámetros de la función
% K es la matriz de transformación con respecto al origen
% alto es la altura del cono
% radio es el radio de la base
% color es uno de los colores básicos RGB, amarillo y gris
